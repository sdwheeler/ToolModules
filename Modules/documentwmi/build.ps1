...
if ($publish) {
    ...
    New-ExternalHelp -Path ./${moduleName}/docs -OutputPath $moduleDeploymentDir
    Copy-Item -Force "$PSScriptRoot/${moduleName}/${moduleName}*" $moduleDeploymentDir
}
