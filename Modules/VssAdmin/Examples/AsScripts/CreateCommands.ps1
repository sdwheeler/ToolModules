...
$handler.Handler = './ParseProvider.ps1'
...
$handler = New-OutputHandler
$handler.Handler = './ParseShadow.ps1'
$handler.HandlerType = 'Script'
$handler.ParameterSetName = 'Default'
$newCommand.OutputHandlers += $handler
...
$handler = New-OutputHandler
$handler.Handler = './ParseShadowStorage.ps1'
$handler.HandlerType = 'Script'
...
$newCommand.OutputHandlers = @()
$handler = New-OutputHandler
$handler.Handler = './ParseVolume.ps1'
$handler.HandlerType = 'Script'
$handler.ParameterSetName = 'Default'
$newCommand.OutputHandlers += $handler
...
$newCommand.OutputHandlers = @()
$handler = New-OutputHandler
$handler.Handler = './ParseWriter.ps1'
$handler.HandlerType = 'Script'
$handler.ParameterSetName = 'Default'
$newCommand.OutputHandlers += $handler
...
$handler = New-OutputHandler
$handler.Handler = './ParseResizeShadowStorage.ps1'
$handler.HandlerType = 'Script'
...
if (-not (Test-Path .\out)) { md .\out}
Export-CrescendoCommand -command $Commands -fileName .\PSVssAdmin.Crescendo.json -Force
Export-CrescendoModule -ModuleName .\out\PSVssAdmin -ConfigurationFile .\PSVssAdmin.Crescendo.json -Force
#endregion
